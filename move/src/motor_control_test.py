...
class Motor_controller(object):
    def __init__(self):
        ...
        #rospy.Timer(rospy.Duration(0.1), self.limitation)
        ...
        if len(position_msg.name) > 0:
            ...
            for i in range(len(position_msg.name)):
                if position_msg.name[i] == "motor1":
                    ...
                    if position2 < int(2233000 - 0.8*1969135.8):
                        position2 = int(2233000 - 0.8*1969135.8)
                    elif position2 > int(2233000 + 0.6*1969135.8):
                        position2 = (2233000 + 0.6*1969135.8)
...
#速度控制程序
    ...
    def control_loop(self):
        if len(self.joy_msg.axes) > 0:
            if self.joy_msg.buttons[4] == 1:
                ...
                value3 = int(-200 * self.joy_msg.axes[3])
    ...
    def limitation(self):
        #左转限位
        if self.position1_last > 2.1:
            position1_limitation1 = int(387350 + 2*137358.156)
            position1_limitation1 = self.value_to_cammand(position1_limitation1, 'pose')
            for i in range(2):
                    self.send_command(self.con1, '1000', '0000')
                    rospy.sleep(0.2)
                    self.send_command(self.con1, '12B2', position1_limitation1)
                    rospy.sleep(0.2)
        #右转限位
        if self.position1_last < -2.1:
            position1_limitation2 = int(387350 - 2*137358.156)
            position1_limitation2 = self.value_to_cammand(position1_limitation2, 'pose')
            for i in range(2):
                    self.send_command(self.con1, '1000', '0000')
                    rospy.sleep(0.2)
                    self.send_command(self.con1, '12B2', position1_limitation2)
                    rospy.sleep(0.2)
        #向前俯身限位
        if self.position2_last > 0.82:
            position2_limitation1 = int(2233000 - 0.8*1969135.8)
            position2_limitation1 = self.value_to_cammand(position2_limitation1, 'pose')
            for i in range(2):
                    self.send_command(self.con2, '1000', '0000')
                    rospy.sleep(0.2)
                    self.send_command(self.con2, '12B2', position2_limitation1)
                    rospy.sleep(0.2)
        #后仰限位
        if self.position2_last < -0.62:
            position2_limitation2 = int(2233000 + 0.6*1969135.8)
            position2_limitation2 = self.value_to_cammand(position2_limitation2, 'pose')
            for i in range(2):
                    self.send_command(self.con2, '1000', '0000')
                    rospy.sleep(0.2)
                    self.send_command(self.con2, '12B2', position2_limitation2)
                    rospy.sleep(0.2)
        #下降限位
        if self.position3_last < 0.11:
            position3_limitation1 = int(3310000 - 0.12*13240000)
            position3_limitation1 = self.value_to_cammand(position3_limitation1, 'pose')
            for i in range(2):
                    self.send_command(self.con3, '1000', '0000')
                    rospy.sleep(0.2)
                    self.send_command(self.con3, '12B2', position3_limitation1)
                    rospy.sleep(0.2)
        #上升限位
        if self.position3_last > 0.23:
            position3_limitation2 = int(3310000 - 0.22*13240000)
            position3_limitation2 = self.value_to_cammand(position3_limitation2, 'pose')
            for i in range(2):
                    self.send_command(self.con3, '1000', '0000')
                    rospy.sleep(0.2)
                    self.send_command(self.con3, '12B2', position3_limitation2)
                    rospy.sleep(0.2)
        rospy.sleep(0.2)
